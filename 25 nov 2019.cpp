...
int harga[10], banyak[10], x, y, total, total1, total2, bayar, bayar2, jml; 
int pilih, kategori;

char pilih1, pilih2, pilih3, pilih4, pilih5;
...
void membayar()
{
		...
		cout<<"\nPunya kode diskon? (y/n)"; cin>>pilih5;
		
		if(pilih5=='Y' || pilih5=='y')
		{
			diskon();
		}
		else
...
void diskon()
{
	...
	cout<<"\nMasukan Kode Diskon :"; cin>>kode;
			if(kode=="enak")
			{
				...
				cout<<"Diskon : "<<diskon;
				jml=total-diskon;
				cout<<"\nTotal yang harus dibayarkan : "<<jml;

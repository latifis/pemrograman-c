...
void cetakantrian(){
	if(!queuekosong()){
        ...
        bantu = qdepan;
        do{
            cout << "Nama yang diundang : " << bantu->infonama << endl;
            cout << "Jumlah orang yang datang : " << bantu->infojumlah << endl;
            cout << "Warna Souvenir : " << bantu->infowarna << endl;
            bantu = bantu->next;
        } while(bantu != NULL);
    } else {
